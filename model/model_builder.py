...
def SlowFast(input_shape=(None, 64, 64, 1), num_fusions=3):
    ...
    slow = conv3d_bn(input_s, 32, (1, 5, 5), strides=(1, 2, 2), padding='same')
    ...
    new_fast = conv3d_bn(fast, 16, (5, 3, 3), strides=(4, 1, 1), padding='same')  # Adjust number of frames for fusion
    ...
    new_fast = conv3d_bn(fast, 64, (5, 3, 3), strides=(4, 1, 1), padding='same')  # Adjust number of frames for fusion
    slow = Concatenate()([slow, new_fast])
    ...
    new_fast = conv3d_bn(fast, 128, (5, 3, 3), strides=(4, 1, 1), padding='same')  # Adjust number of frames for fusion
    slow = Concatenate()([slow, new_fast])
    #
    # slow = MaxPooling3D(pool_size=(1, 2, 2), strides=(1, 1, 1), padding='same')(slow)
    # fast = MaxPooling3D(pool_size=(1, 2, 2), strides=(1, 1, 1), padding='same')(fast)
